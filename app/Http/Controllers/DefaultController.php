...
class DefaultController extends Controller
{
    ...
    public function index()
    {
        ...
        ->select('services.*','users.username','purchases.status','purchases.purchase_state','purchases.names','purchases.id as purchase_id','medias.id as media_id','purchases.created_at as purchase_creation')
