        ...
        <div class="col-md-9 main-content p-3">
            <div class="row">
              <div class="col-md-12 py-4 pr-b">
                <p class="h4"><span class="bg-primary p-2 shadow rounded-lg"><i class="fas fa-house-user text-white"></i></span> Administrateur / Liste des artistes </p>              </div>
            </div>
                ...
                <div class="table-responsive-md">
                    <table class="table">
                      ...
                      <tbody id="contentUsers">
                          @isset($users_artistes)
                              @foreach ($users_artistes as $user)
                                <tr class="filter">
