      ...
      <div>
        <div>
          <ul class="list-group">
            ...
            <li><a  class="list-group-item d-flex justify-content-between align-items-center border-0">Mes Services</a></li>
            <li><a href="/commande" class="list-group-item d-flex justify-content-between align-items-center border-0">Mes albums</a></li>
          </ul>
        </div>
      </div>
