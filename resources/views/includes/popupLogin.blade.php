      ...
      <div class=" rounded-lg popup-shadow">
        <div class="" style="border-radius: 7px 7px 0 0; background:#e7cbc2">
          <div class="position-relative text-center p-3" style="bottom:30px">
            <div class="mx-auto">
              ...
              <div class="">
                <p class="w-75 mx-auto mb-0 text-center h4 pt-3">Bienvenu <span> arsene</span> !</p>
              </div>
          </div>
        ...
        <form class="">
          <div class="p-md-4 p-3 bg-white">
            ...
            <p class="text-center"><a href="#" class="text-decoration-none text-muted">Avez-vous oublié votre mot de passe?</a> </p>

            <p class="text-center">Etre vous inscrit? <a href="#" data-dismiss="modal" aria-label="Close" data-toggle="modal" data-target="#modalRegister">Inscrivez-vous</a> </p>
          </div>
          <div class="p-md-4 p-3 text-center" type="submit" style="border-radius: 0 0 7px 7px; background:#6f23ff">
            <p class="text-white mb-0 text-uppercase">Se connecter
