<!-- Modal-->
<div  class="modal fade" id="modalEditService" tabindex="-1" aria-labelledby="modalEditDefaultLabel" aria-hidden="true">
          ...
          <div class="" style="border-radius: 7px 7px 0 0; background:#e7cbc2">
            <div class="position-relative text-center p-3" style="bottom:30px">
              <div class="mx-auto">
                ...
                <div class="">
                  <p class="w-75 mx-auto mb-0 text-center h4 pt-3">Modifiez le service</p>

                </div>
            </div>

          </div>
          <form method="POST" id="edit-service">
            @csrf
            {{ method_field('patch') }}
