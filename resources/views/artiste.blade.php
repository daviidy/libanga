      ...
      <div class="row">
        <div class="col-md-4">
          <div class="card w-100 p-3 card-shadow">
            <img src="{{($artistes->image) ? asset($artistes->image) : "/assets/images/users/avatar_default.png"}}" class="card-img-top rounded-circle img-fluid text-center m-auto avatar-card" alt="...">
