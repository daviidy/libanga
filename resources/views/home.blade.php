...
@section('content')
          ...
          <div class="row">
            <div class="col-12 col-md-12 d-flex flex-column cta px-md-3 px-0 py-5">
              ...
              <div class="text-left mt-md-5 my-4 text-center">
                ...
                @else
                    <a style="background-color: #2EBD50 !important;" href="#" class="text-decoration-none box-hover h-auto rounded-pill py-3 px-5 mt-3 mb-5 text-white btn-h btn-shadow" data-toggle="modal" data-target="#modalRegister">S'inscrire</a>
                @endif
              </div>
            </div>
      ...
      <section class="container-fluid mb-md-5">
        ...
        <div class="d-flex justify-content-center">
            ...
            <a href="{{route('nosartistes')}}" class="box-shadow btn bg-hero text-white rounded-lg btn-lg">Voir Plus</a>
