        ...
        <nav class="navbar navbar-expand-lg navbar-light">
          ...
          <div class="collapse navbar-collapse" id="navbarNavDropdown">
            ...
            <div class="mt-md-0 mt-4">
              <a href="#" class="text-decoration-none h-auto rounded-pill py-3 px-5 text-white btn-h-2 btn-shadow">
                S'inscrire
              </a>
            </div>
            <div class="dropdown">
          ...
          <div class="row">
            <div class="col-12 col-md-7 d-flex flex-column cta px-md-3 px-0 py-5">
              ...
              <div class="text-left mt-md-5 my-4">
                <a href="#" class="text-decoration-none box-hover h-auto rounded-pill py-3 px-5 mt-3 mb-5 text-white btn-h btn-shadow">S'inscrire</a>
              </div>
            </div>
