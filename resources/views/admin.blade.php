        ...
        <div class="col-md-9 main-content p-3">
          <div class="row">
            <div class="col-md-12 py-4 pr-b">
              <p class="h4"><span class="bg-primary p-2 shadow rounded-lg"><i class="fas fa-house-user text-white"></i></span> Administrateur </p>
            </div>
          </div>
          <div class="row mt-3">
            <div class="col-md-12">
              <div class="card-deck">
                <div class="card shadow border-0 box-hover">
                  ...
                  <div class="card-body pcard-box">
                    <h5 class="card-title text-center font-weight-bold">Gérer vos annonces</h5>
                  </div>
                  </a>
                </div>
                <div class="card shadow border-0 box-hover">
